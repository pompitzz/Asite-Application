...
import com.tas.beaconzz.Board.BoardListAdapter;
...
public class ShareFragment extends Fragment  {
    ...
    public void onActivityCreated(Bundle b){
        ...
        shareListView = (ListView)  getView().findViewById(R.id.shareListView);
        shareList = new ArrayList<Share>();
        adapter = new ShareListAdapter(getContext().getApplicationContext(),shareList, this);
        ...
        writeButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(getContext(), ShareWriteActivity.class);
    ...
    class BackgroundTask extends AsyncTask<Void, Void, String> {
        ...
        protected void onPreExecute() {
            try {
                target = "http://dm951125.dothome.co.kr/ShareList.php";
            } catch (Exception e) {
                e.printStackTrace();
            }
        }
        ...
        public void onPostExecute(String result) {
            try {
                shareList.clear(); // 해당 강의 목록 초기화
                JSONObject jsonObject = new JSONObject(result);
                JSONArray jsonArray = jsonObject.getJSONArray("response");
                int count = 0;
                String boardTitle, boardContent, boardDate, boardName, boardNumber, boardImageUrl;
                while (count < jsonArray.length())
                {
                    ...
                    boardImageUrl = object.getString("boardImageUrl");
                    Share share = new Share(boardTitle, boardContent, boardDate,  boardName, boardNumber, boardImageUrl);
                    shareList.add(share);
                    count++;
                }
