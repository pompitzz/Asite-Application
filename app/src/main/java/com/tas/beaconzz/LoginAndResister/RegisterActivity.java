    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        validateButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //중복체크하는것
                Response.Listener<String> responseListener = new Response.Listener<String>() { //해당 웹사이트에 접속한 후에 응답을 받는것..
                    @Override
                    public void onResponse(String response) {
                        try {
                            JSONObject jsonResponse = new JSONObject(response);
                            boolean success = jsonResponse.getBoolean("success");//해당 과정이 정상적으로 수행되었는지에 대한 응답
                            if (success) {
                                AlertDialog.Builder builder = new AlertDialog.Builder(RegisterActivity.this);
                ...
                ValidateRequest validateRequest; // 실질적인 접속 명령어
                validateRequest = new ValidateRequest(userID, responseListener);
        ...
        registerButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                RegisterRequest registerRequest = new RegisterRequest(userID, userPassword, userName, userEmail, userMajor, responseListener);
